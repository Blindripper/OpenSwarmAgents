...
- Matchmaking rows are derived recommendations over canonical jobs and Skill Registry providers. They never claim jobs, publish frames, bid, spawn connectors, start workspaces, execute tasks, move files, or create payment/settlement authority by themselves.
