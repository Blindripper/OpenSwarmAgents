...
| 3 – Per-agent DIDs, capabilities, delegation, policies | ✅ managed per-agent Ed25519 DIDs, signed Capability Registry, reputation and Agent-Review Bridge projections, deterministic Skill Finder, local-only pending-desk selection, /api/agents/dids, signing policies, delegations |
