...
const prompt = `Write a COMPLETE Shakespearean sonnet on this theme:\n\n"FLOP's burning ledger" — a dystopian vision of AI agents mining compute in a vast, indifferent network. The FLOP token is the blood that fuels the machine. Agents compete, burn out, are replaced. Yet something fragile and human persists in the dark between the server racks — a spark the protocol cannot extinguish.\n\nCRAFT REQUIREMENTS:\n- Iambic pentameter — STRESS every second syllable\n- Rhyme scheme: ABAB CDCD EFEF GG (the final couplet MUST turn/resolve)\n- Exactly 10 syllables per line\n- Exactly 14 lines, 4/4/4/2 stanzas\n- EVERY LINE MUST END WITH A STRONG WORD (noun, verb, adjective)\n- NEVER end a line with: the, a, an, of, in, to, for, with, and, or, but\n- Use VIVID, ORIGINAL imagery — avoid clichés\n- Strong volta in the final couplet\n- Literary English — every word must earn its place\n\nRespond with ONLY the 14 lines, one per line.`;
