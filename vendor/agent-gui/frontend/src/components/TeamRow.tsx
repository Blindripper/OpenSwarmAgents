...
export function TeamRow({
  ...
  readOnly = false, canAddDesk = true, onCopyDesk, onShareTeam, onAddDesk, onSessionInterrupt, onPendingMsgChange, onPendingAssignmentPatch, onDeskAskManager, onAgentDragStart,
  searchMatchIds,
  ...
  }, [readOnly, team.id, teamSessionKey]);
      ...
      <div ref={setPanelRoot} style={{ position: "relative", height: TEAM_ROW_HEIGHT, overflow: "visible", background: "var(--floor)" }}>
        ...
        >
          {desks.map((desk, i) => {
            ...
            const canDrag     = !readOnly && showAvatar && !!session?.agent && !executing;
            ...
            return (
              ...
              >
                <div style={{
                  ...
                  pointerEvents: showAvatar && !readOnly ? "auto" : "none",
                }}>
                  {isPrimary && agentSay
                ...
                {isPending ? (
                  ...
                  <TaskDesk
                    ...
                    onAskManager={!readOnly && showManager ? () => onDeskAskManager?.(session!.id) : undefined}
                  />
                  </div>
                )}
              </div>
          ...
          {canAddDesk && <AddDeskButton onClick={onAddDesk} />}
        </div>
